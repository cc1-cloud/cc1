...
def get_list(cm_id, caller_id, **data):
    ...
    # images = cm(cm_id).image.admin_cm.list(caller_id, cm_passwd, data)
...
def set_private(cm_response, **data):
    ...
    """
    return cm_response
    # return cm(cm_id).image.admin_cm.set_private(caller_id, cm_passwd, id, {'leader_groups': [g.id for g in user.own_groups]})
