...
"""@package src.wi.utils.messages_codes
...
ERRORS = {
    ...
    'vm_novnc_not_found':        _('Error: cannot find NoVNC port.'),
    ...
    'vm_vnc_not_found':          _('Error: cannot find VNC port.'),
...
MESSAGE_CODES = {
    'farm_create':        _('Error: starting farm: <em>%(name)s</em> (ID: %(id)s) failed.'),
