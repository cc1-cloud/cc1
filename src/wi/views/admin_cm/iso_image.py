...
"""@package src.wi.views.admin_cm.iso_image
...
@admin_cm_permission
@csrf_protect
def cma_ajax_copy_iso(request, id1, template_name='generic/form.html', form_class=CopyToUserForm):
    """
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            prep_data(('admin_cm/iso_image/copy/', dictionary), request.session)
