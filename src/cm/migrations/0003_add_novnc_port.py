...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VM.novnc_port'
        db.add_column(u'cm_vm', 'novnc_port',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'VM.novnc_port'
        db.delete_column(u'cm_vm', 'novnc_port')
    ...
    models = {
        ...
        'cm.vm': {
            ...
            'novnc_port': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
