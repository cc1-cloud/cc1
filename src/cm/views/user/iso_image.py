...
def get_by_id(caller_id, iso_image_id):
    ...
    @parameter{iso_image_id,int} id of the Image to get
...
def delete(caller_id, iso_image_id):
    ...
    @parameter{iso_image_id} id of the Image to delete
    """
...
def edit(caller_id, iso_image_id, name, description, disk_controller):
    ...
    @parameter{iso_image_id,int} id of the Image to edit
...
def attach(caller_id, iso_image_id, vm_id):
    ...
    @parameter{iso_img_id,int} id of block device (should be Storage type) - Disk Volume Image
...
def detach(caller_id, iso_image_id, vm_id):
    ...
    @parameter{iso_img_id,int} id of the Storage Image to detach - Disk Volume Image
